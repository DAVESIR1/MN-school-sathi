...
export default {
    ...
    app: {
        ...
        loading: 'Loading EduNorm...',
        welcome: 'Welcome to EduNorm',
    ...
    sidebar: {
        ...
        manageDataFields: 'Manage Data Fields',
        addNewDataBox: 'Add New Data Box',
        ...
        downgradeClass: 'Downgrade Class',
    ...
    backup: {
        ...
        confirmRestore: 'This will replace all current data. Are you sure?',
    ...
    messages: {
        ...
        selectStandardFirst: 'Please select a standard first',
